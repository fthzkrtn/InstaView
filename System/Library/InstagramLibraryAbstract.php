...
namespace Instaphp\library;

abstract class InstagramLibraryAbstract implements \Iterator, \ArrayAccess, \Countable {
	...
	public function addData( \instaphp\library\InstagramLibraryAbstract $object ) {
